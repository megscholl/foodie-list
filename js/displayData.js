...
// // let restaurantName = grabRestaurantData.restaurantData.name;
// // let restaurants = "";
// // let cities = "";
...
// //         <select>
// //             <option value="${grabRestaurantData}">${grabRestaurantData}</option> // grabRestaurantData will be replaced with the results from the loops through the City Data array
// //         </select> 
// //     </div>
// // </form>
// // `;
